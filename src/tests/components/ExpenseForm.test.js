...
test('should render expense form w/ data', () => {
...
test('should set amount w/ valid input', () => {
  const value = '23.5';
  const wrapper = shallow(<ExpenseForm />);
...
test('should not set amount w/ invalid input', () => {
  const value = '12.122';
  const wrapper = shallow(<ExpenseForm />);
  wrapper.find('input').at(1).simulate('change', {
    target: { value },
...
test('should call onSubmit prop w/ valid data', () => {
